    ...
    return (
        ...
        <footer className={styles._7}>
            ...
            <div className={styles._7__socialMediaContainer}>
                ...
                <div className={styles._7__socialMediaContainer___container}><FaFacebookF/></div>
                <div className={styles._7__socialMediaContainer___container}><FaTwitter/></div>
                <div className={styles._7__socialMediaContainer___container}><FaInstagram/></div>
            </div>
        </footer>
